...
public class Menu : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom()
    {
        ...
        photonView.RPC("UpdateLobbyUI", RpcTarget.All); //change I made check of there are any error
    ...
    {
        NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "Game"); //another change
    }
